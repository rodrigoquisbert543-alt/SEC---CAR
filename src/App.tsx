...
function AccessScreen({ onLogin }: { onLogin: (name: Account['name']) => void }) {
  ...
  return <div className="auth-shell"><div className="auth-panel"><div className="auth-brand"><div className="brand-mark"><img src="/logo-seccar.jpg" alt="SEC-CAR" /></div><div><strong>SEC-CAR</strong><span>Centro de Educación Cristiana</span></div></div>
